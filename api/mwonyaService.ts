...
export const api_artistDetails = async (id: string): Promise<MwonyaArtistDetailsResponse> => {
    try {
        const response = await axiosInstance.post(`/artist.php?artistID=${id}&user_ID=mwUWTsKbYeIVPV20BN8or955NA1J43&page=1`);
